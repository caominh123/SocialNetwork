...
public class MainActivity extends AppCompatActivity {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("profileimage")) {
                            ...
                            Toast.makeText(MainActivity.this, "Bạn chưa cập nhật avatar !!!", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void SendUserToFriendsListActivity() {
        Intent friendListIntent = new Intent(MainActivity.this, FriendsListActivity.class);
